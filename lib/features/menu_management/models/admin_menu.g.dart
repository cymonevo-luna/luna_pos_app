...
_AdminMenuRequest _$AdminMenuRequestFromJson(Map<String, dynamic> json) =>
    _AdminMenuRequest(
      ...
      availableStock: _intFromJson(json['available_stock']),
      sellPrice: _intFromJson(json['sell_price']),
      recipeYield: _nullableIntFromJson(json['recipe_yield']),
      marginPercent: _nullableDecimalFromJson(json['margin_percent']),
      vatPercent: _nullableDecimalFromJson(json['vat_percent']),
    );
...
Map<String, dynamic> _$AdminMenuRequestToJson(_AdminMenuRequest instance) =>
    <String, dynamic>{
      ...
      'available_stock': _intToJson(instance.availableStock),
      'sell_price': _intToJson(instance.sellPrice),
      'recipe_yield': _nullableIntToJson(instance.recipeYield),
      'margin_percent': _nullableDecimalToJson(instance.marginPercent),
      'vat_percent': _nullableDecimalToJson(instance.vatPercent),
    };
