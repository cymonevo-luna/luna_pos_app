...
mixin _$ReceiptData {
 ...
 String get brandName; String get branchName; String get branchAddress; String get branchPhone; String get cashierName; String get transactionId; DateTime get transactionDate; String get paymentMethod; List<ReceiptLineItem> get items; int get subtotalAmount; int get discountAmount; int get totalAmount; int? get cashTendered; int get changeAmount; String get thankYouNote;
...
@override
int get hashCode => Object.hash(runtimeType,brandName,branchName,branchAddress,branchPhone,cashierName,transactionId,transactionDate,paymentMethod,const DeepCollectionEquality().hash(items),subtotalAmount,discountAmount,totalAmount,cashTendered,changeAmount,thankYouNote);
...
@useResult
$Res call({
 String brandName, String branchName, String branchAddress, String branchPhone, String cashierName, String transactionId, DateTime transactionDate, String paymentMethod, List<ReceiptLineItem> items, int subtotalAmount, int discountAmount, int totalAmount, int? cashTendered, int changeAmount, String thankYouNote
});
...
/// Create a copy of ReceiptData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? brandName = null,Object? branchName = null,Object? branchAddress = null,Object? branchPhone = null,Object? cashierName = null,Object? transactionId = null,Object? transactionDate = null,Object? paymentMethod = null,Object? items = null,Object? subtotalAmount = null,Object? discountAmount = null,Object? totalAmount = null,Object? cashTendered = freezed,Object? changeAmount = null,Object? thankYouNote = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String brandName,  String branchName,  String branchAddress,  String branchPhone,  String cashierName,  String transactionId,  DateTime transactionDate,  String paymentMethod,  List<ReceiptLineItem> items,  int subtotalAmount,  int discountAmount,  int totalAmount,  int? cashTendered,  int changeAmount,  String thankYouNote)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReceiptData() when $default != null:
return $default(_that.brandName,_that.branchName,_that.branchAddress,_that.branchPhone,_that.cashierName,_that.transactionId,_that.transactionDate,_that.paymentMethod,_that.items,_that.subtotalAmount,_that.discountAmount,_that.totalAmount,_that.cashTendered,_that.changeAmount,_that.thankYouNote);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String brandName,  String branchName,  String branchAddress,  String branchPhone,  String cashierName,  String transactionId,  DateTime transactionDate,  String paymentMethod,  List<ReceiptLineItem> items,  int subtotalAmount,  int discountAmount,  int totalAmount,  int? cashTendered,  int changeAmount,  String thankYouNote)  $default,) {final _that = this;
switch (_that) {
case _ReceiptData():
return $default(_that.brandName,_that.branchName,_that.branchAddress,_that.branchPhone,_that.cashierName,_that.transactionId,_that.transactionDate,_that.paymentMethod,_that.items,_that.subtotalAmount,_that.discountAmount,_that.totalAmount,_that.cashTendered,_that.changeAmount,_that.thankYouNote);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String brandName,  String branchName,  String branchAddress,  String branchPhone,  String cashierName,  String transactionId,  DateTime transactionDate,  String paymentMethod,  List<ReceiptLineItem> items,  int subtotalAmount,  int discountAmount,  int totalAmount,  int? cashTendered,  int changeAmount,  String thankYouNote)?  $default,) {final _that = this;
switch (_that) {
case _ReceiptData() when $default != null:
return $default(_that.brandName,_that.branchName,_that.branchAddress,_that.branchPhone,_that.cashierName,_that.transactionId,_that.transactionDate,_that.paymentMethod,_that.items,_that.subtotalAmount,_that.discountAmount,_that.totalAmount,_that.cashTendered,_that.changeAmount,_that.thankYouNote);case _:
  return null;
...
class _ReceiptData extends ReceiptData {
  const _ReceiptData({required this.brandName, required this.branchName, required this.branchAddress, required this.branchPhone, required this.cashierName, required this.transactionId, required this.transactionDate, required this.paymentMethod, required final  List<ReceiptLineItem> items, required this.subtotalAmount, this.discountAmount = 0, required this.totalAmount, this.cashTendered, this.changeAmount = 0, required this.thankYouNote}): _items = items,super._();
...
@override
int get hashCode => Object.hash(runtimeType,brandName,branchName,branchAddress,branchPhone,cashierName,transactionId,transactionDate,paymentMethod,const DeepCollectionEquality().hash(_items),subtotalAmount,discountAmount,totalAmount,cashTendered,changeAmount,thankYouNote);
